...
import com.tems.baldaonline.domain.GameUser;
...
public class AdapterList extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvFirstWord = convertView.findViewById(R.id.list_item__tv_first_word);
        TextView tvSecondWord = convertView.findViewById(R.id.list_item__tv_second_word);
        TextView tvFirstCount = convertView.findViewById(R.id.list_item__tv_first_cnt);
        TextView tvSecondCount = convertView.findViewById(R.id.list_item__tv_second_cnt);
