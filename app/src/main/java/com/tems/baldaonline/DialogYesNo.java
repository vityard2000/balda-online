...
public class DialogYesNo  extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.dialog_yes_no__bt_yes).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        view.findViewById(R.id.dialog_yes_no__bt_no).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dismiss();
